  ...
  function initTabs() {
    if ($(".tab").length) {
      $(".tab").on("click", function () {
        ...
        window.location.replace("#" + $(this).html().toLowerCase());
      });
    }
    if (window.location.href.indexOf("#") > -1) {
      const tabName = window.location.href.split("#")[1];
      const tab = $(".tab").filter(function () {
        return $(this).html().toLowerCase() === tabName;
      });
      if (tab.length) {
        tab.click();
      } else {
